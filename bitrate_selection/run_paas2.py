...
from envs.paas_env2 import PAASEnv
from models.pass_dqn2 import DQNPolicy
...
def train(args, config, policy, qoe_weights, models_dir, file_prefix):
    ...
    def train_fn(epoch, env_step):
        ...
        if env_step <= 25000:
            ...
            eps = args.eps_train - (env_step - 25000) / \
                  50000 * (0.9 * args.eps_train)
            policy.set_eps(eps)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='PAAS2')
    ...
    # experiment special
    parser.add_argument('--model', type=str, default='paas2')
