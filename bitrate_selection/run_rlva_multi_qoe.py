...
from tianshou.policy import A2CPolicy, DQNPolicy
from tianshou.trainer import OnpolicyTrainer
from tianshou.utils import TensorboardLogger
from tianshou.utils.net.common import ActorCritic
from envs.rlva_multi_qoe_env import RLVAMultiQoEEnv
from models.rlva_multi_qoe import FeatureNet, Actor, Critic
...
def train(args, config, policy, qoe_weights, models_dir, file_prefix):
    ...
    env = RLVAMultiQoEEnv(config, args.train_dataset, args.network_dataset, qoe_weights, valid_log_path, config.startup_download,
    ...
    train_env = SubprocVectorEnv(
        [lambda: RLVAMultiQoEEnv(config, args.train_dataset, args.network_dataset, qoe_weights, train_log_path, config.startup_download,
    ...
    valid_env = DummyVectorEnv(
        [lambda: RLVAMultiQoEEnv(config, args.train_dataset, args.network_dataset, qoe_weights, valid_log_path, config.startup_download,
...
def test(args, config, policy, qoe_weights, models_dir, results_dir, file_prefix):
    ...
    test_env = RLVAMultiQoEEnv(config, args.test_dataset, args.network_dataset, qoe_weights, test_log_path, config.startup_download,
...
def run(args, config):
    ...
    actor = Actor(feature_net, feature_dim=7 * 128, action_space=config.action_space, device=args.device)
    critic = Critic(feature_net, feature_dim=7 * 128, device=args.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='rlva_multi_qoe')
    ...
    # experiment special
    parser.add_argument('--model', type=str, default='rlva_multi_qoe')
    ...
    parser.add_argument('--qoe-train-ids', type=int, nargs='*')  # train on one qoe
    ...
    # On Wu2017
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --test --qoe-train-id 0 --qoe-test-ids 0 --test-on-seen --device cuda:0 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --test --qoe-train-id 1 --qoe-test-ids 1 --test-on-seen --device cuda:1 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --test --qoe-train-id 2 --qoe-test-ids 2 --test-on-seen --device cuda:2 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --test --qoe-train-id 3 --qoe-test-ids 3 --test-on-seen --device cuda:3 --seed 1

    # On Jin2022
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --train-dataset Jin2022 --test --test-dataset Jin2022 --qoe-train-id 0 --qoe-test-ids 0 --test-on-seen --device cuda:0 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --train-dataset Jin2022 --test --test-dataset Jin2022 --qoe-train-id 1 --qoe-test-ids 1 --test-on-seen --device cuda:1 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --train-dataset Jin2022 --test --test-dataset Jin2022 --qoe-train-id 2 --qoe-test-ids 2 --test-on-seen --device cuda:2 --seed 1
    # python run_rlva.py --epochs 100 --step-per-epoch 6000 --step-per-collect 2000 --batch-size 256 --train --train-dataset Jin2022 --test --test-dataset Jin2022 --qoe-train-id 3 --qoe-test-ids 3 --test-on-seen --device cuda:3 --seed 1
